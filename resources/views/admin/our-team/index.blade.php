        ...
        <div class="page-header">
            <div class="breadcrumb-line">
                ...
                <ul class="breadcrumb-elements">
                    <a href="{{ route('our-team.create') }} " class="btn btn-success">Create </a>
                </ul>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @foreach($informations as $k => $information)
                                            <tr>
                                                ...
                                                <td> <img height='100px'
                                                        src="{{ asset('/uploads/ourTeam/thumbnails/' . $information->image) }}" />
                                                </td>
                                                <td>
                                                    <a href="{{ route('our-team.edit', $information->id) }}"
                                                        class="btn btn-primary btn-sm form-inline"><i class="fa fa-edit"></i></a>
                                                    <button class="btn btn-sm btn-danger"
                                                        onclick="return confirm('You Want to Delete?');"
                                                        data-task="{{ $information->id }}" id="dltBtn"><i class="fa fa-trash">
                                                        </i></button>
                                                </td>
                                            </tr>
                                        @endforeach
