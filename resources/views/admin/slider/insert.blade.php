            ...
            <form id="demo-form2" method="post" action="{{url('slider/')}}" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <textarea class="form-control ckeditor" type="text" name="heading"
                   placeholder="Please Enter Your Heading"></textarea>
                </div>
                <div class="col-md-6">
                  <label for="exampleInputSlug">{{ __('adminstaticword.SubHeading') }}:<sup class="redstar">*</sup></label>
                  <textarea type="slug" class="form-control ckeditor" name="sub_heading"

                  id="exampleInputPassword1" placeholder="Please Enter Your Sub Heading"></textarea>
                </div>
              </div>
              <br>
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  ...
                  <textarea name="detail" rows="1" class="form-control ckeditor" placeholder="Enter Your Detail"></textarea>
                </div>
              </div>
              <br>
