    	 ...
    	 <div class="box-body">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs" id="nav-tab" role="tablist">
              ...
              <li role="presentation"><a href="#guide-settings" aria-controls="settings" role="tab" data-toggle="tab">
                  <i class="flaticon-share" aria-hidden="true"></i>&nbsp;&nbsp;{{ __('Guide SetUp') }}</a></li>
            ...
            <div class="tab-content">
              ...
              <div role="tabpanel" class="fade tab-pane" id="guide-settings">
                <br>
                 @include('admin.setting.guide')
              </div>
            </div>
          </div>
        </div>
