			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<br>
						<input type="file" name="logo" id="logo" class="{{ $errors->has('logo') ? ' is-invalid' : '' }} inputfile inputfile-1"/>
				<label for="logo"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="30" viewBox="0 0 20 17">
                    <path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>{{ __('adminstaticword.ChooseaLogo') }}</span></label>
		...
		<div class="col-md-6">
			<div class="row">
				...
				@if ($errors->has('loader'))
                    <strong class="text-danger">{{ $errors->first('loader') }}</strong>
                @endif
				<div class="col-md-6">
					<label for="exampleInputDetails">{{ __('Loader') }}</label>- <p class="inline info">Size: 35x35</p>
					<br>
					<input type="file" name="loader" id="loader" class="{{ $errors->has('loader') ? ' is-invalid' : '' }} inputfile inputfile-1"/>

					<label for="loader">
                        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="30" viewBox="0 0 20 17">
                            <path d="M10 0l-5.2 4.9h3.3v5.1h3.8v-5.1h3.3l-5.2-4.9zm9.3 11.5l-3.2-2.1h-2l3.4 2.6h-3.5c-.1 0-.2.1-.2.1l-.8 2.3h-6l-.8-2.2c-.1-.1-.1-.2-.2-.2h-3.6l3.4-2.6h-2l-3.2 2.1c-.4.3-.7 1-.6 1.5l.6 3.1c.1.5.7.9 1.2.9h16.3c.6 0 1.1-.4 1.3-.9l.6-3.1c.1-.5-.2-1.2-.7-1.5z"/></svg> <span>{{ __('Choose Loader') }}</span></label>
				</div>
				<div class="col-md-4">
					@if($setting->loader !="")
						<div class="favicon-settings">
							<img src="{{ asset('images/favicon/'.$setting->loader) }}" alt="{{ $setting->loader }}" class="img-responsive">
						</div>
					@else
						<div class="alert alert-danger">
							{{ __('No Loader Found') }}
