...
<div class="page-header">
    <div class="breadcrumb-line">
        ...
        <ul class="breadcrumb-elements">
            <a href="{{ action('Admin\RetreatPageController@create') }} " class="btn btn-success">Create </a>
        </ul>
...
<div class="content">
    <div class="row">
        ...
        <td> {{ $information->created_at }} </td> --}}
                                                            <td>
        {{ Form::open(['method' => 'delete', 'action' => ['Admin\RetreatPageController@destroy', $information->id]]) }}
         <a href="{{ action('Admin\RetreatPageController@edit', $information->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit"> </i></a>
         {{-- <a href="{{ action('Front\FrontController@retreat', $information->slug) }}" class="btn btn-info btn-sm" target="_blank"><i class="fa fa-eye"> </i></a> --}}
