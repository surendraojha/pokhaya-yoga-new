...
<div class="card">
            <div class="card-header">
              ...
              <h2 class="card-title pr-5 btn bg-secondary">Our Facilities</h2>
         
                   

              <a href="{{ action('Admin\FacilitieController@create') }}" class="btn btn-info float-right"><i class="fas fa-plus"></i>Add New</a>
            ...
            @php $sn =1 @endphp
              ...
              <tr>
                  ...
                  <td>{{ $information->created_at->format('j M, Y h:i A') }}</td>
                                                            ...
                                                            <td>
                                            {{ Form::open(['method' => 'delete', 'action' => ['Admin\FacilitieController@destroy', $information->id]]) }}
                                            <a href="{{ action('Admin\FacilitieController@edit', $information->id) }}" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i></a>
