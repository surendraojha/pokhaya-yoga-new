...
<div class="page-header">
    <div class="breadcrumb-line">
        ...
        <ul class="breadcrumb-elements">
            <a href="{{ action('Admin\YogaClassController@create') }} " class="btn btn-success">Create </a>
        </ul>
             ...
             @foreach($informations as $k => $information)
                <tr>
                    ...
                    <td> {{ $information->created_at }} </td>
                                                            ...
                                                            <td>
                                            {{ Form::open(['method' => 'delete', 'action' => ['Admin\YogaClassController@destroy', $information->id]]) }}
                                            <a href="{{ action('Admin\YogaClassController@edit', $information->id) }}" class="btn btn-primary btn-sm">Edit</a>
