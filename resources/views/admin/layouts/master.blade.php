...
<body class="hold-transition skin-blue sidebar-mini fixed">
        ...
        <header class="main-header">
            ...
            <a href="{{ url('/') }}" class="logo">
                ...
                <span class="logo-mini">
                    <img title="{{ $project_title }}" width="20px" src="{{ url('images/favicon/'.$gsetting->favicon) }}"
                        alt="" />
                </span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg">
                    <img title="{{ $project_title }}" width="40px" src="{{ url('images/logo/'.$gsetting->logo) }}"
                        alt="" /></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown admin-nav language">
                            ...
                            <ul class="dropdown-menu animated flipInX">
                                ...
                                <li><a href="{{ route('languageSwitch', $language->local) }}">{{$language->name}}
                                        ({{$language->local}}) </a></li>
                                @endforeach
                                @endif
                            </ul>
                        ...
                        <li><a href="{{ url('/') }}" target="_blank"
                                class="visit site">{{ __('adminstaticword.VisitSite') }}</a></li>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-header">
                                    ...
                                    <p>
                                        {{Auth::User()->fname}}
                                        <small>{{ __('adminstaticword.MemberSince') }}:
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="{{ url('user/edit/'.Auth::User()->id)}}"
                                            class="btn btn-default btn-flat">{{ __('adminstaticword.Profile') }}</a>
                                    </div>
    ...
    <!-- CK Editor -->
    <script src="{{ URL::asset('admin/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}">
    ...
    {{-- course and class load for blog --}}
