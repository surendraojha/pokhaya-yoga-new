    ...
    <div class="col-md-7">
            ...
            <form enctype="multipart/form-data" id="demo-form" method="post" action="{{url('courseclass/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <select name="coursechapter_id" id="chapters" class="form-control ckeditor">
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <textarea name="detail" rows="5"  class="form-control ckeditor"
                   placeholder="Enter Your Details">{{ $cate->detail }}</textarea>
                </div>
              </div>
              <br>
      ...
      <div class="box-body">
        <div class="form-group">
            ...
            <h1>
                <a href="{{ route('classquestions.index',$id) }}">
                    View Questions
                </a>
            </h1>
        </div>
