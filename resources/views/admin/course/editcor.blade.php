                ...
                <div class="form-group">
                    <form action="{{route('course.update',$cor->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug"
                                    id="exampleInputPassword1" value="{{ $cor->slug}}" required>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="exampleInputDetails">{{ __('adminstaticword.Requirements') }}:<sup
                                        class="redstar">*</sup></label>
                                <textarea name="requirement" rows="3" class="form-control ckeditor"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label for="exampleInputTit1e">Why should people invest in this course? <sup
                                        class="redstar">*</sup></label>
                                <textarea name="why_should_invest" rows="3" class="form-control ckeditor"
                                    placeholder="Enter Your Detail" required>{{ $cor->why_should_invest }}</textarea>
                            </div>


                            <div class="col-md-6">
                                <label for="exampleInputTit1e">Target Audience <sup class="redstar">*</sup></label>
                                <input type="text" name="target_audience" value="{{ $cor->target_audience }}"
                                    class="form-control" placeholder="Enter Your Detail" required> </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <textarea id="detail" name="detail" rows="3"
                                    class="form-control ckeditor">{!! $cor->detail !!}</textarea>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            <div class="col-md-3 display-none">
                                ...
                                <li class="tg-list-item">
                                    <input class="tgl tgl-skewed" id="rox" type="checkbox" @if($cor->day !="" &&
                                    $cor->day !="") checked @endif/>
                                ...
                                <div @if($cor->day =="" && $cor->day =="") class="display-none" @endif id="jeet">
                                    ...
                                    <input type="number" min="1" class="form-control" name="day"
                                        id="exampleInputPassword1" placeholder="Please Your Enter day"
                                        value="{{ $cor->day }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                                ...
                                <div @if($cor->price =="" && $cor->price =="") class="display-none" @endif id="doabox">
                                    ...
                                    <input type="number" step="0.01" class="form-control" name="price"
                                        id="exampleInputPassword1" placeholder="Please Your Enter paid"
                                        value="{{ $cor->price }}">
                                </div>

                                <div @if($cor->price =="" && $cor->discount_price =="") class="display-none" @endif
                                    id="doaboxx">
                                    <br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div @if($cor->preview_type =="url" ) class="display-none" @endif id="document1">
                                    <label for="exampleInputSlug">{{ __('adminstaticword.UploadVideo') }}: <sup
                                            class="redstar">*</sup></label>
                                ...
                                <div @if($cor->preview_type =="video") class="display-none" @endif id="document2">
                                    <br>
                                    <label for="exampleInputSlug">{{ __('adminstaticword.URL') }}: <sup
                                            class="redstar">*</sup></label>
                                    <input class="form-control" placeholder="Enter Your URL" name="url" id="url"
                                        value="{{ $cor->url }}">
                                </div>
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <p class="inline info"> - Please enter duration</p>
                                <input min="1" class="form-control" name="duration" type="text"
                                    value="{{ $cor->duration }}"
