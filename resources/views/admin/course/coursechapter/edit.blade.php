      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            {{ Form::model($cate,['method'=>'put','route'=>['coursechapter.update',$cate->id] ,


            'id'=>'demo-form','data-parsley-validate','class'=>'form-horizontal form-label-left','files'=>true]) }}
              {{ csrf_field() }}
              {{-- {{ method_field('PUT') }} --}}
              ...
              <div class="row">
                <div class="col-md-12">
                  ...
                  <br>
                    ...
                    {{-- summary --}}
                    <div class="col-md-12">
                        {{ Form::label('summary','What Learn') }}
                        {{ Form::text('summary',null,['class'=>'form-control','Placeholder'=>'What Learns']) }}
                    </div>
                    ...
                    <div class="col-md-12">
                        {{ Form::textarea('objective',null,['class'=>'form-control ckeditor']) }}
                    </div>
                </div>
