        ...
        <div class="page-header">
            <div class="breadcrumb-line">
                ...
                <ul class="breadcrumb-elements">
                    <a href="{{ route('curriculam-category.create') }} " class="btn btn-success">Create </a>
                </ul>
                                        ...
                                        @foreach($informations as $k => $information)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ['curriculam-category.destroy', $information->id]]) }}
                                                    <a href="{{ route('curriculam-category.edit', $information->id) }}"
