...
src="https://www.facebook.com/tr?id=594742474993226&ev=PageView&noscript=1"
/></noscript>
<!-- End Facebook Pixel Code -->


 <!-- Global site tag (gtag.js) - Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-173922310-2"></script>
<script>
...
window.addEventListener('load', function() {
    jQuery('[href="https://www.pokharayogaschoolandretreatcenter.com/customer-register"]').click(function() {
				gtag('event', 'conversion', {'send_to': 'AW-10775170677/FJZxCN615vgCEPWcgJIo'});
    });
    if(window.location.pathname=="/thank-you"){
    	gtag('event', 'conversion', {'send_to': 'AW-10775170677/eOUpCPnLsvYCEPWcgJIo'});
    }
    
		jQuery('.apply').click(function() {
				gtag('event', 'conversion', {'send_to': 'AW-10775170677/WOEwCNOq6PgCEPWcgJIo'});
    });
 ...
 <nav class="navbar navbar-expand-lg navbar-light">
     ...
     <div class="col-12 col-sm-12 col-md-2 col-lg-2 header-right">
       <ul class="wow shake" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: shake; ">
         ...
         <li><a href="{{ Route('customer.refer.page') }}" class="applys mt-3" hreflang="en">Refer & Earn 100 Euro<i class="fas fa-pen-square"></i></a></li>
       </ul>
     </div>
   </div>
 </div>
   ...
   <div class="col-12 col-sm-12 ">
     <nav class="navbar navbar-expand-lg navbar-light">
       <a class="navbar-brand" href="{{action('Front\FrontController@index')}}">
         <img src="{{asset('uploads/'.$setting->logo)}}" alt=""></a>
       ...
       <div class="collapse navbar-collapse" id="navbarSupportedContent">
         <ul class="navbar-nav ml-auto">
           ...
           @if(session()->has('User'))
           <li class="nav-item dropdown ">
             <a class="nav-link" href=""><img src="{{ asset('uploads/pp.jpg') }}" width="60px" height="30px"></a>
             <ul>
             <li><a href="{{action('Front\FrontController@userprofile_dashboard')}}">{{session('name')}} Dashboard</a></li>
             <li><a href="{{action('Front\FrontController@register_yoga')}}">Join Yoga</a></li>
             <li><a  href="{{action('Front\FrontController@logout')}}">Logout</a></li>
           </ul>
           </li>
         ...
         @else
           ...
           @endphp
             ...
             <ul>
                 ...
                 <li><a href="{{ route('customer.refer.page') }}">Refer & Earn 100 Euro</a></li>
     ...
     <div class="container">
       <div class="row">
         <div class="col-12 col-sm-12">
           ...
           <div id="mySidenav" class="sidenav">
             ...
             <div class="mobile-menus">
               <ul>
                 ...
                 <li><a  href="{{action('Front\FrontController@curriculam')}}">Curriculam</a></li>
                 <li>
           ...
           <li class="">
             <a class="" href="{{route('customer.refer.page')}}">Refer & Earn 100 Euro</a>
           </li>
           ...
           <li>
             <a href="#"  type="text" data-toggle="collapse" data-target="#multiCollapseExample3"
             aria-expanded="false" aria-controls="multiCollapseExample3"  >Join Us  <i class="wsmenu-arrow fa fa-angle-down "></i> </a>
           ...
           <li>
             <a href="#"  type="text" data-toggle="collapse" data-target="#multiCollapseExample3"
             aria-expanded="false" aria-controls="multiCollapseExample3"  >Dashboard  <i class="wsmenu-arrow fa fa-angle-down "></i> </a>
             <div class="collapse multi-collapse" id="multiCollapseExample3">
               <div class="card card-body">
                 <ul>
                     <li><a href="{{ route('customer.booking.index')}}">My Bookings</a></li>
                     ...
                     <li><a href="{{ route('customer.refer.page') }}">Refer and Earn 100 Euro</a></li>
