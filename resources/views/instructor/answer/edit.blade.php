...
@section('title', 'Edit Comment - Instructor')
@section('body')
    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header with-border">
          <h3 class="box-title"> {{ __('adminstaticword.Edit') }} {{ __('Comment') }}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          <div class="form-group">
            <form action="{{url('instructoranswer/'.$answer->id)}}" method="POST" enctype="multipart/form-data">
                ...
                <label class="display-none" for="exampleInputSlug">{{ __('adminstaticword.SelectCourse') }}</label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label for="exampleInput"> {{ __('Comment') }}:<sup class="redstar">*</sup></label>
