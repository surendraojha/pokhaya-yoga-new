 <!-- sidebar-1 -->
                    <div class="col-sm-4">
                        ...
                        <div class="news-wrapper">
                            ...
                            <div class="news-title"><h2><span class="fa fa-list-alt"></span> Latest News</h2> <a class="pull-right" href="{{action('Front\FrontController@newsEvent')}}">View all news <span class="fa fa-angle-double-right"></span> </a></div>
                        ...
                        <div class="news-package">
                            <a href="{{action('Front\FrontController@singlePost',$notice->id)}}" class="pb-2news-titles ">{{$notice->title}} </a>
