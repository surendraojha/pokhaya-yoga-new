                        ...
                        <div class="card">
                            <div class="card-banner">
                                <a href="{{ route('yoga-class.single-page', $training->slug) }}">
                                    <img class="banner-img" src="{{ asset('uploads/' . $training->image) }}"
                                        alt="{{ $training->title }}">
                                </a>
                            </div>
                            <div class="card-body">
                                <h2 class="blog-title">
                                    <a
                                        href="{{ route('yoga-class.single-page', $training->slug) }}">{{ $training->title }}</a>
                                </h2>
                                <p>{{ Str::limit(strip_tags($training->content), 80) }}</p>
                                <a href="{{ route('yoga-class.single-page', $training->slug) }}"
                                    class="btn btn-views">Apply
                                    Now</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                        <div class="image-box">
                            ...
                            <div class="text-overlay">
                                <h2><a
                                        href="{{ route('yoga-class.single-page', $course->slug) }}">{{ $course->title }}</a>
                                </h2>
    ...
    <div class="choose-section">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3"><img src="{{ asset('images/train7.png') }}"
                        alt=""></div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3"><img src="{{ asset('images/train3.jpg') }}"
                        alt=""></div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3"><img src="{{ asset('images/img.jpg') }}" alt="">
                </div>
                <div class="col-12 col-sm-6 col-md-6 col-lg-3"><img src="{{ asset('images/train4.jpg') }}"
                        alt=""></div>
            </div>
        </div>
    </div>
...
══════════════════════════════════════ --}}
    <div class="comming-section">
        <div class="container">
            <div class="row">
                <div class="col-12 col-sm-12">
                    <h4>Why Coming To Pokhara, Nepal?</h4>
                    <p>Nepal is an ancient land where yogis and sages have made their mark for thousands of years. Its
                        history and geography make this the perfect place for seekers and yogis to take a break of the noise
                        and demands of modern life, and step onto the yogic path.</p>
                    <p>Pokhara Yoga School is your best choice if you are looking for YTT Courses in Nepal, dedicated
                    ...
                    <p>Embark upon a unique adventure of yoga and spirituality in the lap of the Himalayas, under the
                        guidance of acclaimed teachers at Pokhara Yoga School.</p>
                    ...
                    <div class="owl-two owl-carousel owl-theme">
                        @forelse ($testimonials as $test)
                            <div class="item">
                                <a href="#">
                                    <img class="lazy"
                                        src="{{ asset('uploads/testimonials/thumbnails/' . $test->image) }}"
                ...
                <div class="col-12 col-sm-12 col-md-6 col-lg-6 testi-right">
                    ...
                    <div class="owl-three owl-carousel owl-theme">
                        @foreach ($videoTestimonials as $testimonial)
                            ...
                            @endphp
                            <div class="item">
                                <div class="yt-thumb-wrap" data-embed="{{ $embedUrl }}"
                                    onclick="openYtLightbox(this)"
