            ...
            <div class="col-lg-8">
                <div class="about-home-block text-white">
                    ...
                    <ul>
                        ...
                        <li>
                            @php
                            $number_of_students = App\Order::where('course_id', $course->id)->count();
                            // if(count($data)>0){
                    ...
                    <ul>
                        <li><a href="#" title="about">{{ __('frontstaticword.Created') }}: {{ $course->user['fname'] }}
                            </a></li>
                        <li><a href="#" title="about">{{ __('frontstaticword.LastUpdated') }}:
                                {{ date('jS F Y', strtotime($course['updated_at'])) }}</a></li>
                        @if($course['language_id'] == !NULL)
                        <li><a href="#" title="about"><i class="fa fa-comment"></i></a> {{ $course->language['name'] }}
                        </li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="about-home-icon text-white text-right">
                    <ul>
                        ...
                        <li class="about-icon-one">
                            <form id="demo-form2" method="post" action="{{ url('show/wishlist', $course->id) }}"
                                ...
                                <button class="wishlisht-btn" title="Add to wishlist" type="submit"><i
                                        class="fa fa-heart rgt-10"></i>{{ __('frontstaticword.Wishlist') }}</button>
                            </form>
                        </li>
                        @else
                        <li class="about-icon-two">
                            <form id="demo-form2" method="post" action="{{ url('remove/wishlist', $course->id) }}"
                                data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <button class="wishlisht-btn" title="Remove from Wishlist" type="submit"><i
                                        class="fa fa-heart rgt-10"></i>{{ __('frontstaticword.Wishlisted') }}</button>
                            </form>
                        </li>
                        @endif
                        @else
                        <li class="about-icon-one"><a href="{{ route('login') }}" title="heart"><i
                                    class="fa fa-heart rgt-10"></i>{{ __('frontstaticword.Wishlist') }}</a></li>
                        @endif
                    </ul>
                </div>
                ...
                <div class="about-home-product">
                    <div class="video-item hidden-xs">
                        ...
                        <div class="video-device">
                            ...
                            <img src="{{ asset('images/course/'.$course['preview_image']) }}" class="bg_img img-fluid"
                                alt="Background">
                            @else
                        ...
                        <div class="about-home-dtl-block btm-10">
                            ...
                            <div class="about-home-rate">
                                <ul>
                                    ...
                                    <li><span><s><i class="{{ $currency->icon }}"></i>{{ $course['price'] }}</s></span>
                                    </li>
                                    @else
                            ...
                            <div class="about-home-btn btm-20">
                                <a href="{{url('show/coursecontent',$course->id)}}" class="btn btn-secondary"
                                    title="course">{{ __('frontstaticword.GoToCourse') }}</a>
                            </div>
                            @else
                            @if(isset($course->duration))
                            <div class="course-duration btm-10">{{ __('frontstaticword.EnrollDuration') }}:
                                ...
                                <form id="demo-form2" method="post"
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" class="btn btn-primary"><i class="fa fa-cart-plus"
                                                aria-hidden="true"></i>&nbsp;Enroll Now</button>
                                    </div>
                                </form>
                            </div>
                            @endif
                            ...
                            @if($enroll == NULL)
                            <div class="about-home-btn btm-20">
                                <a href="{{url('enroll/show',$course->id)}}" class="btn btn-primary"
                                    title="Enroll Now">EnrollNow</a>
                            </div>
                            @else
                            <div class="about-home-btn btm-20">
                                <a href="{{url('show/coursecontent',$course->id)}}" class="btn btn-secondary"
                            ...
                            <div class="about-home-includes-list btm-40">
                                <ul class="btm-40">
                                    ...
                                    @if($in->status ==1)
                                    <li><i
                                            class="fa {{ $in->icon }}"></i>{{ str_limit($in->detail, $limit = 50, $end = '...') }}
                                    </li>
                                    @endif
                                    @endforeach
                                    @endif
                            ...
                            <div class="about-home-share text-center">
                                <a href="#" data-toggle="modal" data-target="#myModalshare" title="share"><i
                                        class="fa fa-share rgt-10"></i>share</a>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">
                                                {{ __('frontstaticword.Sharethiscourse') }}</h4>
                                            ...
                                            <div class="panel panel-sum">
                                                <div class="modal-body">
                                                    ...
                                                    <div class="nav-search">
                                                        ...
                                                        <button onclick="myFunction()" class="btn btn-primary">Copy
                                                            Text</button>
                                                    </div>
    ...
    <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-4">
                                            <div class="instructor-img btm-30">
                                                ...
                                                <a href="{{ route('instructor.profile', $course->user->id) }}"
                                        ...
                                        <div class="col-lg-8 col-sm-8">
                                            <div class="instructor-block">
                                                <div class="instructor-name btm-10"><a
                                                        href="{{ route('instructor.profile', $course->user->id) }}"
                                                        title="instructor-name">{{ $course->user['fname'] }}</a></div>
                                                <div class="instructor-post btm-20">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="product-learn-heading">
                    Objectives
                    </h2>
                    <div class="description-block btm-30">
                    ...
                    <h3 class="product-learn-heading">
                        Why should people invest in this course?
                        </h2>
                        <div class="description-block btm-30">
                                {!! $course['why_should_invest']
                                !!}
                        ...
                        <div class="description-block btm-30">
                            <p> <strong>Number Of Enrolled Students: </strong> {{ $number_of_students }} </p>
                        ...
                        ?>
                            ...
                            <div class="featured-review-block">
                                ...
                                <div class="review">{{ __('frontstaticword.helpful') }}?
                                    @php
                                    $help = App\ReviewHelpful::where('user_id', Auth::User()->id)->where('review_id',
                                    $rating->id)->first();
                                    @endphp

                                    @if($help == !NULL)
                                    <div class="helpful">
                                        <form method="post" action="{{route('helpful.delete', $course->id)}}"
                                            data-parsley-validate class="form-horizontal form-label-left">
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-link lft-7 rgt-10 yes-submitted"><i
                                                    class="fa fa-check"></i> {{ __('frontstaticword.Yes') }}</button>
                                        </form>
                                    </div>
                                    @else
                                    <div class="helpful">
                                        <form method="post" action="{{route('helpful', $course->id)}}"
                                            data-parsley-validate class="form-horizontal form-label-left">
                                            {{ csrf_field() }}
                                            ...
                                            <button type="submit"
                                                class="btn btn-link lft-7 rgt-10 ">{{ __('frontstaticword.Yes') }}</button>
                                        </form>
                                    </div>
                                    @endif

                                    <a href="#" data-toggle="modal" data-target="#myModalreport"
                                        title="report">{{ __('frontstaticword.Report') }}</a>
                     ...
                     @include('front.course-detail.chapter')
                        ...
                        <div class="description-block btm-30">
                            <p>
                                <strong> Duration:</strong>{{ $course['duration'] }} </p>
                        ...
                        @php
                        $user_enrolled = App\Order::where('course_id', $course->id)->where('user_id', Auth::user()->id)
                        ->first();
                        ...
                        @if( $user_enrolled != NULL || Auth::user()->role == 'admin' )
                                    ...
                                    <div class="faq-dtl">
                                        <div id="accordion" class="second-accordion">
                                            ...
                                            <div class="card">
                                                <div class="card-header" id="headingTwo{{ $meeting->id }}">
                                                    <div class="mb-0">
                                                        <button class="btn btn-link" data-toggle="collapse"
                                                            data-target="#collapseTwo{{ $meeting->id }}"
                                                ...
                                                <div id="collapseTwo{{ $meeting->id }}" class="collapse"
                                                            ...
                                                            <tbody>
                                                                <td>
                                                                    <ul>
                                                                        <li>
                                                                            <a href="#"
                                                                                title="about">{{ __('frontstaticword.Created') }}:
                                                                                {{ $meeting->user['fname'] }} </a>
                                                                        ...
                                                                        <li>
                                                                            <p class="btm-10"><a herf="#">Start At:
                                                                                    {{ date('d-m-Y | h:i:s A',strtotime($meeting['start_time'])) }}</a>
                                                                            </p>
                                                                        </li>
                                                                        <li>
                                                                            <a href="{{ $meeting->zoom_url }}"
                                                                                target="_blank"
                                                                                class="btn btn-light">Join
                                                                                Meeting</a>
                                                                        </li>
                                                                    </ul>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4 col-sm-4 col-5">
                                                    <div class="course-bought-img">
                                                        ...
                                                        '')
                                                        <a
                                                            href="{{ route('user.course.show',['id' => $item->id, 'slug' => $item->slug ]) }}"><img
                                                                src="{{ asset('images/course/'.$item['preview_image']) }}"
                                                ...
                                                <div class="col-lg-6 col-sm-8 col-7">
                                                    <div class="course-name"><a
                                                            href="{{ route('user.course.show',['id' => $item->id, 'slug' => $item->slug ]) }}">{{ str_limit($item['title'], $limit = 35, $end = '...') }}</a>
                                                    </div>
                                                    <div class="course-update">{{ __('frontstaticword.LastUpdated') }}
                                                        {{ date('jS F Y', strtotime($item['updated_at'])) }}</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-2 col-md-3 col-4">
                                            ...
                                            <div class="course-currency txt-rgt">
                                                <ul>
                                                    <li class="rate"><i
                                                            class="{{ $currency['icon'] }}"></i>{{ $item->discount_price }}
                                                    </li>
                                                    <li class="rate"><s><i
                                                                class="{{ $currency['icon'] }}"></i>{{ $item['price'] }}</s>
                                                    </li>
                                                </ul>
                                            </div>
                                            @else
                                            ...
                                            <div class="course-rate txt-rgt">
                                                <ul>
                                                    <li>
                                                        ...
                                                        Auth::User()->id)->where('course_id', $item->id)->first();
                                                        @endphp
                                                        @if ($wishtt == NULL)
                                                        <div class="heart">
                                                            <form id="demo-form2" method="post"
                                                                action="{{ url('show/wishlist', $item->id) }}"
                                                        ...
                                                        <div class="heart-two">
                                                            <form id="demo-form2" method="post"
                                                                action="{{ url('remove/wishlist', $item->id) }}"
                                                                data-parsley-validate
                                                                class="form-horizontal form-label-left">
                                                                {{ csrf_field() }}
                                                        ...
                                                        @endif
                                                        @else
                                                        <div class="heart"><a href="{{ route('login') }}"
                                                                title="heart"><i class="fa fa-heart rgt-10"></i></a>
                                                        </div>
                                                        @endif
                                                    </li>
                                                </ul>
                            ...
                            ?>
                                ...
                                ?>
                                        <div class="pull-left">
                                            <div class="star-ratings-sprite star-ratings-center"><span
                                    ...
                                    ?>
                                        ...
                                        ?>
                                                ...
                                                <div class="pull-left">
                                                    <div class="star-ratings-sprite star-ratings-center"><span
                                                            style="width:%" class="star-ratings-sprite-rating"></span>
                                                    </div>
                                                </div>
                                                @endif
                                            </span>
                                            ...
                                            <span class="bar-block">
                                                <span id="bar-three" style=" width:{{ $ratings_var }}%;"
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <span class="bar-block">
                                                <span id="bar-two" style="width: {{ $ratings_var }}%"
                                                    class="bar bar-clr bar-radius">&nbsp;</span>
                                            </span>
                                        </div>
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            <span class="bar-block">
                                                <span id="bar-one" style="width: {{ $ratings_var }}%"
                                                    class="bar bar-clr bar-radius">&nbsp;</span>
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div class="learning-review btm-40">
                                @php
                                $orders = App\Order::where('user_id', Auth::User()->id)->where('course_id',
                                $course->id)->first();
                                @endphp
                                @if(!empty($orders))
                                <div class="review-block">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-10 col-12">
                                            <form id="my_captcha_form" method="post"
                                                action="{{route('course.rating',$course->id)}}" data-parsley-validate
                                                class="form-horizontal form-label-left">
                                                {{ csrf_field() }}
                                                    ...
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><input type="radio" name="learn" value="1"
                                                                        id="option1" autocomplete="off"></td>
                                                                <td><input type="radio" name="learn" value="2"
                                                                        id="option2" autocomplete="off"></td>
                                                                <td><input type="radio" name="learn" value="3"
                                                                        id="option3" autocomplete="off"></td>
                                                                <td><input type="radio" name="learn" value="4"
                                                                        id="option4" autocomplete="off"></td>
                                                                <td><input type="radio" name="learn" value="5"
                                                                        id="option5" autocomplete="off"></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">{{ __('frontstaticword.Price') }}</th>
                                                                <td><input type="radio" name="price" value="1"
                                                                        id="option6" autocomplete="off"></td>
                                                                <td><input type="radio" name="price" value="2"
                                                                        id="option7" autocomplete="off"></td>
                                                                <td><input type="radio" name="price" value="3"
                                                                        id="option8" autocomplete="off"></td>
                                                                <td><input type="radio" name="price" value="4"
                                                                        id="option9" autocomplete="off"></td>
                                                                <td><input type="radio" name="price" value="5"
                                                                        id="option10" autocomplete="off"></td>
                                                            </tr>
                                                            <tr>
                                                                <th scope="row">{{ __('frontstaticword.Value') }}</th>
                                                                <td><input type="radio" name="value" value="1"
                                                                        id="option11" autocomplete="off"></td>
                                                                <td><input type="radio" name="value" value="2"
                                                                        id="option12" autocomplete="off"></td>
                                                                <td><input type="radio" name="value" value="3"
                                                                        id="option13" autocomplete="off"></td>
                                                                <td><input type="radio" name="value" value="4"
                                                                        id="option14" autocomplete="off"></td>
                                                                <td><input type="radio" name="value" value="5"
                                                                        id="option15" autocomplete="off"></td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                        ...
                        ?>
                                    ...
                                    <div class="row btm-20">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="review-rating">
                                                ...
                                                <div class="review">{{ __('frontstaticword.helpful') }}?
                                                    @php
                                                    $help = App\ReviewHelpful::where('user_id',
                                                    Auth::User()->id)->where('review_id', $rating->id)->first();
                                                    @endphp

                                                    @if($help == !NULL)
                                                    <div class="helpful">
                                                        <form method="post"
                                                            action="{{route('helpful.delete', $course->id)}}"
                                                            data-parsley-validate
                                                            class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}
                                                            <button type="submit"
                                                                class="btn btn-link lft-7 rgt-10 yes-submitted"><i
                                                                    class="fa fa-check"></i>
                                                                {{ __('frontstaticword.Yes') }}</button>
                                                        </form>
                                                    </div>
                                                                ...
                                                                <div class="box box-primary">
                                                                    <div class="panel panel-sum">
                                                                        <div class="modal-body">
                                                                            ...
                                                                            @endphp
                                                                            <form id="demo-form2" method="post"
                                                                                action="{{ route('report.review', $course->id) }}"
                                                                                data-parsley-validate
                                                                                class="form-horizontal form-label-left">
                                                                                {{ csrf_field() }}
                            ...
                            {{-- Related course --}}
                            @include('front.course-detail.related-course')


                        {{-- Report --}}
                        @include('front.course-detail.report')



                            <!--Model start-->
                          @include('front.course-detail.modal')
                            <!--Model close -->
                        </div>
