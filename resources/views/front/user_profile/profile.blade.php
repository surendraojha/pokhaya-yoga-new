...
<section id="profile-item" class="profile-item-block">
    <div class="container">
    	<form action="{{ route('user.profile',$orders->id) }}" id="my_captcha_form" method="POST" enctype="multipart/form-data">
        	{{ csrf_field() }}
            {{ method_field('PUT') }}
	                ...
	                <div class="profile-info-block">
	                    ...
	                    <div class="row">
	                        ...
	                        <div class="col-lg-6">
                             ...
                             <div class="col-lg-6">
	                            <div class="form-group">
                                    <label for="Username">{{ __('Signature') }}</label>
                                    <input type="file" name="signature">

                                </div>


                                <img src="{{ public_path().'/images/user_img/'.$orders->signature }}" alt="">
