                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                <?php
                                    ...
                                    $total_count = $total_assignment_count;
                                    $read_count = $submitted_assignment_count;
...
$progres = ($read_count/$total_count) * 100;
                                ...
                                --}}
                                    ...
                                    <div class="about-home-btn">
                                        <a href="{{ route('cirtificate.show', $course->id) }}" class="btn btn-secondary"
                                            href="#">Get Certificate</a>
                                    </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <li>
                            <a href="{{ route('user.course.show',['id' => $course->id, 'slug' => $course->slug ]) }}"
                                class="course_btn"> {{ __('frontstaticword.Coursedetails') }} <i
                    ...
                    <div class="video-item hidden-xs">
                        <div class="video-device">
                            ...
                            <div class="video-preview">
                                ...
                                @if(@$course->chapter[0]->courseclass[0])
...
$progres = ($read_count/$total_count) * 100;
    ...
    $progres =0;
                    ...
                    @if(@$course->chapter[0]->courseclass[0]->type == "video" ||
                    @$course->chapter[0]->courseclass[0]->type == "audio")
                    @if(@$course->chapter[0]->courseclass[0] !=null)
                    @if(@$course->chapter[0]->courseclass[0]->iframe_url == NULL)
                    <div class="learning-courses-home-btn">
                        <a href="{{ route('watchcourse',$course->id) }}"
                            class="@if($z == 0)iframe @endif btn btn-primary"
                            title="Continue">{{ __('frontstaticword.ContinuetoLecture') }}</a>
                    </div>
                    @else
                    <div class="learning-courses-home-btn">
                        @php
    ...
    <div class="container">
        <div class="about-block">
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link text-center" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                        role="tab" aria-controls="nav-contact" aria-selected="false">{{ __('Topic discuss') }}</a> -->

                        <a class="nav-item nav-link text-center" id="nav-blog-tab" data-toggle="tab" href="#nav-blog"
                        role="tab" aria-controls="nav-quiz" aria-selected="false">{{ __('Discussion Forum') }}</a>
                    ...
                    <a class="nav-item nav-link text-center" id="nav-announcement-tab" data-toggle="tab"
                        ...
                        aria-selected="false">{{ __('frontstaticword.Announcements') }}</a>

                    {{-- Quiz --}}
                    <a class="nav-item nav-link text-center" id="nav-quiz-tab" data-toggle="tab" href="#nav-quiz"
                        role="tab" aria-controls="nav-quiz" aria-selected="false">{{ __('frontstaticword.Quiz') }}</a>
                    ...
                    <a class="nav-item nav-link text-center" id="nav-appoint-tab" data-toggle="tab" href="#nav-appoint"
                        role="tab" aria-controls="nav-appoint"
                        aria-selected="false">{{ __('frontstaticword.Appointment') }}</a>
                    @endif                  
            ...
            <div class="tab-content" id="nav-tabContent">
                <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="overview-block">                        
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="learning-questions-block btm-40">
                                    <h5 class="learning-questions-heading">{{ __('frontstaticword.RecentQuestions') }}
                                    </h5>

                                    @if($coursequestions->isEmpty())
                                    <div class="learning-questions-content text-center">
                                        <h3 class="text-center">{{ __('frontstaticword.No') }}
                                            {{ __('frontstaticword.RecentQuestions') }}</h3>
                                    </div>
                                    @else
                                    @php
                                    $questions = App\Question::where('course_id',
                                    $course->id)->orderBy('created_at','desc')->limit(2)->get();
                                    @endphp
                                    @foreach($questions as $question)
                                    <div class="learning-questions-dtl-block">
                                        <div class="learning-questions-img rgt-20">
                                            {{ @$question->user->fname[0] }}{{ @$question->user->lname[0] }}</div>
                                        <div class="learning-questions-dtl"><a href="#"
                                                title="questions">{{ $question->question }}</a>
                                        </div>
                                    </div>
                                    @endforeach
                                    @endif
                                    <div class="learning-questions-heading"><a href="#" id="goTab3"
                                            title="browse">{{ __('frontstaticword.Browsequestions') }}</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="learning-questions-block btm-40">
                                    <h5 class="learning-questions-heading">
                                        {{ __('frontstaticword.RecentAnnouncements') }}</h5>
                                    @if($announsments->isEmpty())
                                    <div class="learning-questions-content text-center">
                                        <h3 class="text-center">{{ __('frontstaticword.No') }}
                                            {{ __('frontstaticword.RecentAnnouncements') }}</h3>
                                    </div>
                                    @else
                                            ...
                                            <div class="card-header" id="headingFour{{ $announsment->id }}">
                                                <div class="mb-0">
                                                    <button class="btn btn-link" data-toggle="collapse"
                                                        ...
                                                        <div class="learning-questions-img rgt-20">
                                                            {{ @$announsment->user->fname[0] }}{{ @$announsment->user->lname[0]  }}
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="section"><a href="#"
                                                                        title="questions">{{ $course->user->fname }}
                                                                        {{ $announsment->user->lname }}</a> <a href="#"
                                                                        title="questions">{{ date('jS F Y', strtotime($announsment->created_at)) }}</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 offset-3 col-9 offset-sm-0">
                                                                <div class="profile-heading">
                                                                    {{ __('frontstaticword.Announcements') }}</div>
                                                            </div>
                                    ...
                                    @endif
                                    <div class="learning-questions-heading"><a id="goTab4" href=""
                                            title="browse">{{ __('frontstaticword.Browseannouncements') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="content-course-number-block">
                                ...
                                <div class="col-lg-6 col-sm-5">
                                    <div class="content-course-number">
                                        <ul>
                                            ...
                                            <li>{{ __('frontstaticword.Languages') }}: {{ $course->language->name }}
                                            </li>
                                            @endif
                                        </ul>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-3">
                                    <div class="content-course-number">{{ __('Duration') }}</div>
                                </div>
                                <div class="col-lg-9">
                                    <div class="content-course-number content-course-one">
                                        <p>{{ $course->duration }} <p>
                ...
                {{-- Course content tab --}}
                @include('front.course-content.content')
            </div>
                            ...
                            <div class="contact-search-block btm-40">
                                <div class="learning-contact-search">
                                    ...
                                    <h4 class="question-text">
                                        @php
                                        $quess = App\Question::where('course_id',
                                        $course->id)->where('status','1')->get();
                                        @endphp
                                        ...
                                        {{ __('Topics to Discuss') }}</h4>
                                    @endif

                                </div>
                                <div class="learning-contact-btn">
                                    <button type="button" class="btn btn-primary" data-toggle="modal"
                                        data-target="#myModal">{{ __('Add Discussion Topic') }}
                                    </button>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="demo-form2" method="post"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="hidden" name="instructor_id"
                                                                    class="form-control" value="{{$course->user_id}}" />
                                                        ...
                                                        <!-- <div class="row">
                                                            <div class="col-md-12">
                                                                <label for="detail">{{ __('Discussion Topic') }}:<sup
                                            ...
                                            <button class="btn btn-link" data-toggle="collapse"
                                                ...
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-lg-3 col-3">
                                                        <div class="profile-heading txt-rgt"><a href="#"
                                                                data-toggle="modal"
                                                                data-target="#myModalanswer{{ $ques->id }}"
                                                                title="response">{{ __('Add Comment') }}</a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="demo-form2" method="post"
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <label for="detail">{{ __('Comment') }}:<sup
                                                                                class="redstar">*</sup></label>
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title" id="myModalLabel">
                                                        {{ __('frontstaticword.Report') }} Topic</h4>
                                                    <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close"><span
                                                            aria-hidden="true">&times;</span></button>
                                                </div>
                                            ...
                                            <div class="answer-block">
                                                <div class="row no-gutters">
                                                    ...
                                                    <div class="col-lg-11 col-10">
                                                        ...
                                                        <div class="section">
                                                            <a href="#" title="questions">{{ $ans->user->fname }}</a> <a
                                                                href="#"
                        ...
                        <div id="accordion" class="second-accordion">
                            ...
                            <div class="card btm-30">
                                <div class="card-header" id="headingFive{{ $announsment->id }}">
                                    <div class="mb-0">
                                        <button class="btn btn-link" data-toggle="collapse"
                                            data-target="#collapseFive{{ @$announsment->id }}" aria-expanded="true"
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="section"><a href="#"
                                                            title="questions">{{ $announsment->user->fname }}
                                                            {{ $announsment->user->lname }}</a> <a href="#"
                                                            title="questions">{{ date('jS F Y', strtotime($announsment->created_at)) }}</a>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div
                                                    class="col-lg-12 offset-3 col-9 offset-sm-0 col-sm-12 offset-md-0 col-md-12">
                ...
                <div class="container">
                    <div class="quiz-main-block">
                        <div class="row">
                            ...
                            <?php
                                                    $order = App\Order::where('course_id', $course->id)
                                    ...
                                    <div class="card blue-grey darken-1">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6 col-7">
                                                    <ul class="topic-detail">
                                                        <li>{{ __('frontstaticword.PerQuestionMark') }}<i
                                                                class="fa fa-long-arrow-right"></i></li>
                                                        <li>{{ __('frontstaticword.TotalMarks') }}<i
                                                                class="fa fa-long-arrow-right"></i></li>
                                                        <li>{{ __('frontstaticword.TotalQuestions') }}<i
                                                                class="fa fa-long-arrow-right"></i></li>
                                                        <li>{{ __('frontstaticword.QuizPrice') }}<i
                                                                class="fa fa-long-arrow-right"></i></li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="card-action text-center">
                                            ...
                                            <a href="{{route('start_quiz', ['id' => $topic->id])}}"
                                                class="btn btn-block" title="Start Quiz">
                                                {{ __('frontstaticword.StartQuiz') }}</a>

                                            @endif
                                            @else
                                            <a href="{{route('start.quiz.show',$topic->id)}}"
                                                class="btn btn-block">{{ __('frontstaticword.ShowQuizReport') }}
                                            </a>

                                            @if($topic->quiz_again == '1')
                                            <a href="{{route('tryagain',$topic->id)}}"
                                                class="btn btn-block">{{ __('frontstaticword.TryAgain') }} </a>
                                            @endif
                                            @endif
                    ...
                    <div class="assignment-main-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                @if($assignment_questions->isEmpty()==false)
                                        ...
                                        <div class="categories-block assign-tab-one text-center">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    @php
                                                    $chapter = \App\CourseChapter::find($value->chapter_id)
                                                    @endphp
                                                    ...
                                                    <td>
                                                        <div class="udemy-contact-btn text-center">
                                                            <button type="button" class="btn btn-primary"
                                                                data-toggle="modal" onclick="setValue({{ $value->chapter_id }},
                                                                {{ $value->id }})"
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <a href="" data-toggle="tooltip" data-placement="top"
                                                            title="{{ $assign->rating }}/10 scores"><i
                                                                class="far fa-check-circle" title="approved"></i></a>
                                                        @else
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="assignment-delete-block text-right">
                                                            ...
                                                            <a href="{{ asset('files/assignment/'.$assign->assignment) }}"
                                                                download="{{$assign->assignment}}" title="Download"> <i
                                            ...
                                            <div class="panel panel-sum">
                                                <div class="modal-body">
                                                    <form id="demo-form2" method="post"
                                                        ...
                                                        data-parsley-validate class="form-horizontal form-label-left"
                                                        enctype="multipart/form-data" id="my_captcha_form">
                                                        {{ csrf_field() }}


                                                        {{-- chapter modal id --}}

                                                        <input type="hidden" name="course_chapters"
                                                            id="chapter_modal_id">

                                                        {{-- question modal_id --}}

                                                        <input type="hidden" name="question_id" id="question_modal_id">
                                                        ...
                                                        <div class="row text-center">
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="wrapper">
                                                                        <label for="detail">{{ __('Content') }}:<sup
                                                                                class="redstar">optional</sup></label>
                                                                        <textarea name="detail" id="detail" cols="30"
                                                                            rows="10"></textarea>
                ...
                <div class="row">
                                ...
                                <div class="categories-block assign-tab-one text-center">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <form method="post" action="{{url('appointment/delete/'.$appoint->id)}}"
                                                ata-parsley-validate class="form-horizontal form-label-left">
                                                {{ csrf_field() }}

                                                <button type="submit" class="cart-remove-btn display-inline"
                                        ...
                                        @if($appoint->accept == 1)
                                        <li><a href="" data-toggle="modal" data-target="#myModalresponse"
                                                title="response">Response</a></li>

                                        <div class="modal fade" id="myModalresponse" tabindex="-1" role="dialog"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        ...
                                                        <h4 class="modal-title" id="myModalLabel">
                                                            {{ __('frontstaticword.Response') }}</h4>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                            aria-label="Close"><span
                                                                aria-hidden="true">&times;</span></button>
                                                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="contact-search-block btm-40">
                            <div class="udemy-contact-btn text-center">
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#appointmodel">{{ __('frontstaticword.RequestAppointment') }}
                                </button>
                            </div>
                            <div class="modal fade" id="appointmodel" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" id="myModalLabel">
                                                {{ __('frontstaticword.RequestAppointment') }}</h4>
                                            <button type="button" class="close" data-dismiss="modal"
                                                aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        </div>
                                        <div class="box box-primary">
                                                    ...
                                                    <form id="demo-form2" method="post"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="title">{{ __('frontstaticword.User') }}:<sup
                                                                            class="redstar">*</sup></label>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="title">{{ __('frontstaticword.Instructor') }}:<sup
                                                                            class="redstar">*</sup></label>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="title">{{ __('frontstaticword.Date') }}:<sup
                                                                            class="redstar">*</sup></label>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    <label
                                                                        for="detail">{{ __('frontstaticword.Title') }}:<sup
                                                                            class="redstar">*</sup></label>
...
{{-- Discussion Forum --}}
    <div class="tab-pane fade" id="nav-blog" role="tabpanel" aria-labelledby="nav-blog-tab">
        <div class="overview-block">
            <h4>{{ __('Discussion Forum') }}</h4>

            
            {{-- url for chapter load --}}
            <input type="hidden" name="chapter_load" id="chapter_load" value="{{ url('blog/get-chapter') }}">

            {{-- url for class load --}}

            <input type="hidden" name="class_load" id="class_load" value="{{ url('blog/get-class') }}">

            {{-- url for blog title load --}}

            <input type="hidden" name="blog_load" id="blog_load" value="{{ url('blog/get-blog') }}">

            {{-- url for blog load --}}
            <input type="hidden" name="blog_url" id="blog_url" value="{{ url('detail/blog') }}">
            {{-- ram --}}
            ...
            <div class="content-course-number-block">
                <div class="row">
                    <div class="col-lg-3 col-sm-4" id="blog-title">
