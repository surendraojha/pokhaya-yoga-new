                    ...
                    <div class="cirtificate-border-two">
                       <div class="cirtificate-heading" style=""> {{ __('frontstaticword.CertificateofCompletion') }}</div>
                        @php
                            ...
                            // dd($mytime);
                        @endphp
                       <p class="cirtificate-detail" style="font-size:30px"> {{ __('frontstaticword.Thisistocertifythat') }}<b>&nbsp;{{ Auth::User()['fname'] }}&nbsp;{{ Auth::User()['lname'] }}</b>  {{ __('frontstaticword.successfullycompleted') }}
                        <b>{{ $course['title'] }} </b> <i>{{ $course['duration'] }}</i>  {{ __('frontstaticword.onlinecourseon') }} <br>
                       ...
                       <div class="cirtificate-logo">
                            <img src="{{ asset('images/user_img/'.$course->user['signature']) }}" class="img-fluid" alt="logo">
