            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                    ...
                    <a class="nav-item nav-link text-center" id="nav-contact-tab" data-toggle="tab" href="#nav-contact"
                        role="tab" aria-controls="nav-contact" aria-selected="false">{{ __('Topic Discussion') }}</a>
                    ...
                    <a class="nav-item nav-link text-center" id="nav-blog-tab" data-toggle="tab" href="#nav-blog"
                        role="tab" aria-controls="nav-quiz" aria-selected="false">{{ __('Blogs') }}</a>
                        ...
                        <form method="post" action="{{ action('CourseProgressController@checked', $course->id) }}"
                            ...
                            <div id="accordion" class="second-accordion">
                                ...
                                <div id="collapseChapter{{ $coursechapter->id }}" class="collapse"
                                    ...
                                    {{-- check if there is a quiz available or not --}}
                                    @php
